...
if (args.length === 0) {
  console.error('Usage: npm run generate-token -- <browser-name> [user-id] [email] [name]');
  console.error("Example: npm run generate-token -- chrome '123' user@example.com 'User Name'");
  process.exit(1);
}
